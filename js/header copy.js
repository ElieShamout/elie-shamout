...
window.addEventListener("scroll",function(){
    ...
    // About me
    if (scrollVal>(document.querySelector(".home-page").offsetHeight)){
        TargetLine(1);
    }
    
    // Skills
    if (scrollVal>
        (document.querySelector(".home-page").offsetHeight+document.querySelector(".skills").offsetHeight)){
        TargetLine(2);
    }
    ...
    if (scrollVal>=
        ...
        /
        (document.querySelectorAll("#my-work-content .project-item").length/3)){
        TargetLine(3);
    }
    ...
    if (scrollVal>=
        ...
        document.querySelector(".skills").offsetHeight+
        document.querySelector(".my-work").offsetHeight+
        document.querySelector(".contactBox").offsetHeight)/1.1){
        TargetLine(4);
    }
    ...
    if (scrollVal>=
        ...
        document.querySelector(".contactBox").offsetHeight)){
        TargetLine(5);
    }
